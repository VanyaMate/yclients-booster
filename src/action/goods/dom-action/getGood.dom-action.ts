...
export const getGoodDomAction = function (dom: Document): GoodData {
    ...
    if (form) {
        ...
        const unit_equals     = (form.querySelector<HTMLInputElement>('input[name="unit_equals"]')!.value);
        const service_unit_id = Number(form.querySelector<HTMLSelectElement>('select[name="service_unit_id"]')!.value);
        const netto           = (form.querySelector<HTMLInputElement>('input[name="netto"]')!.value);
        const brutto          = (form.querySelector<HTMLInputElement>('input[name="brutto"]')!.value);
        const cost            = (form.querySelector<HTMLInputElement>('input[name="cost"]')!.value);
        const actual_cost     = (form.querySelector<HTMLInputElement>('input[name="actual_cost"]')!.value);
        ...
        const critical_amount = (form.querySelector<HTMLInputElement>('input[name="critical_amount"]')!.value);
        const desired_amount  = (form.querySelector<HTMLInputElement>('input[name="desired_amount"]')!.value);
