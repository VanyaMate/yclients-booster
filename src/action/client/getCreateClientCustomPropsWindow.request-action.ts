...
export const getCreateClientCustomPropsWindowRequestAction = async function (clientId: string, logger?: ILogger): Promise<HTMLDivElement> {
    logger?.log("попытка дополнительные [window] поля в форме создания клиента");
