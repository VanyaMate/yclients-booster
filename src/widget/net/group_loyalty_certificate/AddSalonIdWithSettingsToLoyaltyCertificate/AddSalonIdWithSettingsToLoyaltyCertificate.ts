...
export type AddSalonIdWithSettingsToLoyaltyCertificateProps =
    {
        bearer: string;
        clientId: string;
    }
...
export class AddSalonIdWithSettingsToLoyaltyCertificate extends Component<HTMLDivElement> {
    ...
    constructor (props: AddSalonIdWithSettingsToLoyaltyCertificateProps) {
    ...
    private _renderInitialForm () {
        ...
        const uploadDataButton = new Button({
            ...
            onclick    : async () => {
                ...
                if (clientIdToAdd && clientIdEtalon) {
                            ...
                            certificates.map((certificate) => ({
                                chain: [
                                    ...
                                    async (fulldata: GroupLoyaltyCertificateData) => {
                                        ...
                                        if (
                                            salonIds.includes(clientIdToAdd) ||
                                            !salonIds.includes(clientIdEtalon)
                                        ) {
                                            return fulldata;
                                        }
